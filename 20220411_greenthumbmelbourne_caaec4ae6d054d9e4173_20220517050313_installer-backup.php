...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220411_greenthumbmelbourne_caaec4ae6d054d9e4173_20220517050313_archive.zip';
	const ARCHIVE_SIZE		 = '556084585';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'caaec4a-17050313';
    const SECONDARY_PACKAGE_HASH = 'f932589-17050313';
	const VERSION			 = '1.4.5';
