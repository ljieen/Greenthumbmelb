...
<div style="border:1px solid black;width:320px;margin-right:10px;padding:0px;float:left;"> 
 ...
 <div style="padding-right:5px;padding-left:5px;color:#888888;">* Submissions per day in the selected date range.<br />&nbsp;&nbsp; Days from <?php echo esc_html($date_start); ?> to <?php echo esc_html($date_end); ?>.</div>
</div> 
...
?>
 ...
 <div style="padding-right:5px;padding-left:5px;color:#888888;">&nbsp;&nbsp;* Number of times that appears each value. Percent in relation to the total of submissions.<br />&nbsp;&nbsp;&nbsp;&nbsp; Date range from <?php echo esc_html($date_start); ?> to <?php echo esc_html($date_end); ?>.</div>
</div>
