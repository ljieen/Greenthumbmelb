...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
       ...
       <table class="form-table">    
        ...
        <br ><span style=font-size:11px;">* Note: <a href="https://wordpress.dwbooster.com/forms/cp-polls#download">Professional version</a> also supports the option "<strong>One per WordPress logged in user - retricts votes to logged in users</strong>".</span>
        </td>
        </tr>
        <tr valign="top">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">   
     ...
     <div style="padding:10px;background-color:#ffffdd;border:1px dotted black;">
        ...
        <ul>
            <li>- <a STYLE="FONT-WEIGHT:BOLD;" href="https://wordpress.dwbooster.com/forms/cp-polls#download">CP Polls Pro</a> with a <strong>complete set of form fields</strong>, multi-page forms, etc...</li>
            <li>- <a STYLE="FONT-WEIGHT:BOLD;" href="https://wordpress.dwbooster.com/forms/calculated-fields-form#download">Calculated Fields Form</a> for <strong>displaying calculations</strong> (ex: quote calculkators) based in the items selected in the form.</li>
            <li>- <a STYLE="FONT-WEIGHT:BOLD;" href="https://wordpress.dwbooster.com/forms/contact-form-to-email#download">Contact Form to Email</a> for <strong>contact forms</strong> with reports.</li>
            <li>- <a STYLE="FONT-WEIGHT:BOLD;" href="https://wordpress.dwbooster.com/forms/cp-contact-form-with-paypal#download">Contact Form with PayPal</a> for connecting the form to <strong>PayPal</strong> payments.</li>
     </div>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">   
     <table class="form-table">    
        ...
        - For general CSS styles modifications to the form and samples <a href="https://wordpress.dwbooster.com/faq/cp-polls#q213" target="_blank">check this FAQ</a>.
        </tr>
     </table>
  </div>    
 </div> 
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <td><select id="cu_user_email_field" name="cu_user_email_field" def="<?php echo esc_attr($this->get_option('cu_user_email_field', CP_POLLS_DEFAULT_cu_user_email_field)); ?>"></select><br /><em> - Note: Not available in this version since the form builder doesn't contain the email field. <a href="https://wordpress.dwbooster.com/forms/cp-polls#download">Check other versions</a>.</em>
        </td>
        </tr>             
        <tr valign="top">
        <th scope="row">Email subject</th>
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <tr valign="top">
         ...
         <td><input type="color" name="cv_background" size="10" value="#<?php echo esc_attr($this->get_option('cv_background', CP_POLLS_DEFAULT_cv_background)); ?>" onchange="generateCaptcha();" /></td>
         <th scope="row">Border:</th>
         <td><input type="color" name="cv_border" size="10" value="#<?php echo esc_attr($this->get_option('cv_border', CP_POLLS_DEFAULT_cv_border)); ?>" onchange="generateCaptcha();" /></td>        
        </tr>    
