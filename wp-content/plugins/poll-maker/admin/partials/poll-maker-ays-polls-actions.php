...
//     $text_shadow = 'text-shadow: '.$poll_title_text_shadow_x_offset.'px '.$poll_title_text_shadow_y_offset.'px '.$poll_title_text_shadow_z_offset.'px '.$poll_title_text_shadow;
// }else{
//     $text_shadow = 'text-shadow: unset';
// }
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 ays_divider_left">
                                    <div>
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" step="50" min="0" class="ays-text-input ays-text-input-short" id='ays-poll-width' name='ays_poll_width' value="<?= $options['width'] ?>"/>
                                        </div>
                                    </div>
                                    <hr>
                                    <div>
