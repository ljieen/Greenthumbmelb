            ...
            <div class="form-group row ays-poll-button-box">
                ...
                <?php
                    if ( $next_poll_cat_id != "" && !is_null( $next_poll_cat_id ) ) {
                        ...
                        submit_button(__('Next Poll Category', $this->plugin_name), 'button button-primary ays_default_btn ays-poll-next-prev-button-class ays-button', 'ays_poll_category_next_button', false, $other_attributes);
                    }
                ?>
                <?php
                    if ( $prev_poll_cat_id != "" && !is_null( $prev_poll_cat_id ) ) {
                        ...
                        submit_button(__('Previous Poll Category', $this->plugin_name), 'button button-primary ays_default_btn ays-poll-next-prev-button-class ays-button', 'ays_poll_category_prev_button', false, $other_attributes);
                    }
                ?>
                </div>
            </div>
