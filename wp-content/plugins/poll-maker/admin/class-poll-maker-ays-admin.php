...
class Poll_Maker_Ays_Admin {
    ...
    public function ays_poll_sale_baner(){
		if(isset($_POST['ays_poll_sale_btn_small_spring'])){
			$sale_date = sanitize_text_field($_POST['ays_poll_sale_btn_small_spring']);
			update_option('ays_poll_sale_notification_'.$sale_date, 1); 
			update_option('ays_poll_sale_date_'.$sale_date, current_time( 'mysql' ));
		}

		if(isset($_POST['ays_poll_sale_btn_spring_small_for_two_months'])){	
				$sale_date = sanitize_text_field($_POST['ays_poll_sale_btn_spring_small_for_two_months']);		
			...
			$content[] = '<div id="ays-poll-dicount-month-main" class="notice notice-success is-dismissible ays_poll_dicount_info">';
				$content[] = '<div id="ays-poll-dicount-month" class="ays_poll_dicount_month">';
					...
					$content[] = '<div class="ays-poll-dicount-wrap-box">';
						...
						$content[] = '<strong>';
							$content[] = __( "The BIGGEST <span class='ays-poll-dicount-wrap-color' style='color:#001E64;'>50%</span> SALE on <br><span><a href='https://ays-pro.com/mega-bundle' target='_blank' class='ays-poll-dicount-wrap-color ays-poll-dicount-wrap-text-decoration' style='display:block;color:#001E64'>Mega Bundle</a></span> (Quiz+Survey+Poll)!", POLL_MAKER_AYS_ADMIN_URL );
						$content[] = '</strong>';

						$content[] = '<br>';

						$content[] = '<strong>';
								$content[] = __( "Hurry up! Ending on. <a href='https://ays-pro.com/mega-bundle' target='_blank' style='color:#001E64;'>Check it out!</a>", POLL_MAKER_AYS_ADMIN_URL );
						$content[] = '</strong>';
					...
					$content[] = '<div class="ays-poll-dicount-wrap-box">';
						...
						$content[] = '<div id="ays-poll-maker-countdown-main-container">';
							...
							$content[] = '<form action="" method="POST">';
								$content[] = '<button class="btn btn-link ays-button" name="ays_poll_sale_btn_winter" style="height: 32px;color:#0041B8" value="mega_bundle_new">Dismiss ad</button>';
								$content[] = '<button class="btn btn-link ays-button" name="ays_poll_sale_btn_winter_for_two_months" style="height: 32px; padding-left: 0;color:#0041B8" value="mega_bundle_new">Dismiss ad for 2 months</button>';
							$content[] = '</form>';
					...
					$content[] = '<a href="https://ays-pro.com/mega-bundle" class="button button-primary ays-button" id="ays-poll-button-top-buy-now" target="_blank">' . __( 'Buy Now !', POLL_MAKER_AYS_ADMIN_URL ) . '</a>';
				$content[] = '</div>';
			$content[] = '</div>';
		// $content[] = '</div>';
		$content = implode( '', $content );
