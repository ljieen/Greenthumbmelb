...
class Poll_Maker_Ays_Public {
	...
	public function ays_poll_generate_html( $poll_id, $echo = true, $width = -1 ) {
		...
		if($poll_logo_check){
			$poll_image_cont = "<div class='ays-image-logo-show'><a href='".$poll_logo_image_url_href."' class='ays-poll-logo-image-url-link' {$target_blank} ><img src=".$poll_logo_image." class='ays-poll-image-logo'></a></div>";
		}
