...
= 3.9.9 =
* Added: Previous Poll button on the Polls Edit page

= 3.9.8 =
* Added: Next Poll button on the Polls Edit page
...
= 3.9.1 =
* Added: Open in a new tab suboption for the Poll logo option
...
* Fixed: Title text shadow style issue on live preview
