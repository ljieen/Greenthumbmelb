...
registerBlockType( 'ultimate-product-catalogue/ewd-upcp-display-catalog-block', {
	...
	edit: function( props ) {
		...
		returnString.push( el( 'div', { class: 'ewd-upcp-admin-block ewd-upcp-admin-block-display-catalog' }, Localize( 'Display Product Catalog Block', 'ultimate-product-catalogue' ) ) );
		return returnString;
	},
