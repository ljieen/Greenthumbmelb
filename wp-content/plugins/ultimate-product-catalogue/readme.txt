...
<strong>Includes Gutenberg block for displaying your product catalog!</strong>
...
<em>This product catalog plugin is very user friendly and comes with a full guided setup (walkthrough). When you activate the plugin, the setup will run and help you create your first products and catalog!</em>
...
* Brazilian Portugese product catalog (Thanks to <a href='https://wordpress.org/support/profile/tito_cadallora'>Tito_Cadallora</a>)
...
* Greek product catalog (Thanks to <a href='https://bigdrop.gr/'>Christoforos A.</a>)
* Italian product catalog
* Lithuanian product catalog (Thanks to <a href='https://wordpress.org/support/profile/adart'>AdArt</a>)
...
A great place to start learning about how to translate a plugin is at the link below: <https://premium.wpmudev.org/blog/how-to-translate-a-wordpress-plugin>
...
* Lightbox, product inquiry form (using Contact Form 7 or WPForms) and product reviews (using <a href='https://wordpress.org/plugins/ultimate-reviews/'>Ultimate Reviews</a>)
...
<https://www.etoilewebdesign.com/support-center/?Plugin=UPCP&Type=FAQs>
...
[youtube https://www.youtube.com/watch?v=l9mWNqOIB_w]
...
= 5.0.3 to 5.0.8 (2021-07-19) =
- Fixes for versioning issues/errors relating to activation of the 5.0 update.

= 5.0.2 (2021-07-19) =
- Please see 5.0.0 and 5.0.1 changelog entries for all details pertaining to the new release.
- Corrected name of UPCP_Main.php file used for automatic re-activation.
...
- 5.0.1 just includes a version number update to help with the automatic activation after updating.
